# SpameakBet v2.1 - [Copyright by SpameakBetting a.s. 2024 - Developed and Modified by @swobodaa08 - SpameakWear s.r.o. 2024]
...
def hlavny_program():
    ...
    if tip_vysledok == vysledok:
        ...
        if goly_tim1 > goly_tim2:    
            print(f"Vyhral tím {nazov1}, perfektne")
        if goly_tim2 > goly_tim1:    
            print(f"Vyhral tím {nazov2}, perfektne")
        else:
            print(f"Bola remíza, perfektne")
        if konto > 0:
