...
def pokracovat():
    ...
    for _ in range(počet_kôl):
        ...
        def submit_tip(event=None):
            ...
            try:
                ...
                if 1 <= entered_guess <= 5:
                    ...
                    # Vygeneruje náhodné číslo a vyhodnotí výsledok
                    cislo = random.randint(1, 5)
                    konto -= suma
                    počet_kôl -= 1

                    # Zobrazí výsledok na plátne
                    if tip == cislo:
                        konto += suma * 3
                    ...
                    canvas.create_text(500, 800, text=f"Zostatok na účte: {konto}€", font=("Helvetica", "20", "bold"), fill="white")

                    # Zobrazí tlačidlo "Pokračovať"
                ...
                show_error2("Chyba", "Zadaj platný tip od 1 do 5!")
        ...
        def pokracuj_na_dalsie_kolo():
            # Vymaže všetko z plátna
            canvas.delete("all")
            # Obnoví pozadie na plátne
            ...
            if počet_kôl > 0:
                ...
                exit_program()  # Ukončí program, ak už nie sú ďalšie kolá
