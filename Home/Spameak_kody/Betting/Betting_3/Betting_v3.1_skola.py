...
def uloz_vysledok(nazov1, goly_tim1, nazov2, goly_tim2):
    ...
    with open("Z:/2024-PI1-Python/2024-PI1-Python/Spameak_Casino/vysledky.txt", "a") as f:
        f.write(vysledok)
...
def hlavny_program():
    global konto
    timy = nacitaj_timy("Z:/2024-PI1-Python/2024-PI1-Python/Spameak_Casino/timy.txt")
