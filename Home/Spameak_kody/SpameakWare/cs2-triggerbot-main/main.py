...
class CS2TriggerBot:
    ...
    def start(self):
        ...
        while not self.stop_event.is_set():
            try:
                ...
                logging.info(f"SpameakWare stopped by user.")
                self.stop()
            except Exception as e:
    ...
    def stop(self):
        ...
        logging.info("SpameakWare stopped.")

class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("CS2 Cheat | SpameakWare.cc")
    ...
    def init_home_tab(self):
        ...
        self.name_app = QLabel(f"SpameakWare.cc {CS2TriggerBot.VERSION} - Best cheats on the world")
        ...
        self.status_label = QLabel("Cheat Status: Stopped")
